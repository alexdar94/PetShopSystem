...
private Vet vet;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Condition of legs, paws, and claws");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frame_Vet_PR_Bird.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Frame_Vet_PR_Bird().setVisible(true);
            }
        });
    }
