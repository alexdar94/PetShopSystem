...
private Appointment appointment;
     ...
     */
    public Frame_Vet_PR_Lizard() {
        initComponents();
    }

    public Frame_Vet_PR_Lizard(Vet vet, Appointment appointment) {
        initComponents();
        this.vet=vet;
    ...
    private void btn_diagnosisMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_diagnosisMouseClicked
        Frame_Vet_DR dr= new Frame_Vet_DR(vet,Enum_Species.Lizard,appointment);
        dr.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frame_Vet_PR_Lizard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Frame_Vet_PR_Lizard().setVisible(true);
            }
        });
    }
